...
static bool VerifyChecksumsFromWorker(const string & MessageFromWorker,
                                      ...
                                      string & ErrorText)
{
   ...
   const bool Result = Expected.hash == ActualHash;
...
// ---------------------------------------------------------------------
/* */
void pkgAcqFile::DoneByWorker(const string &Message,
                              const unsigned long Size,
