...
%filter_from_requires \,%reqs_of_tests_to_filter_out,d
...
if rpm -q %name-tests -R | grep -e '%{reqs_of_tests_to_filter_out}'
then
    echo '^^^ These are unwanted extra reqs of %name-tests'
    exit 1
fi
